...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__qr_scanner__ = __webpack_require__(2217);
...
var CoreViewerQRScannerPage = /** @class */ (function () {
    ...
    CoreViewerQRScannerPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-viewer-qr-scanner',template:/*ion-inline-start:"D:\BKEL\192\HeDieuHanh\Hocphanmorong\moodleappvietsub\moodleapp\src\core\viewer\pages\qr-scanner\qr-scanner.html"*/'<ion-header>\n\n    <ion-navbar core-back-button>\n\n        <ion-title>{{ title }}</ion-title>\n\n\n\n        <ion-buttons end>\n\n            <button ion-button icon-only (click)="cancel()" [attr.aria-label]="\'core.close\' | translate">\n\n                <ion-icon name="close"></ion-icon>\n\n            </button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\BKEL\192\HeDieuHanh\Hocphanmorong\moodleappvietsub\moodleapp\src\core\viewer\pages\qr-scanner\qr-scanner.html"*/,
        }),
